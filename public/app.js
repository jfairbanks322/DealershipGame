...
function sectionNavigation() {
 ...
 : game.phase==='planning'
 ? [['#round-checklist','Round overview'],['.catalog','Menu & prices'],['#round-review','Review & submit'],...(!isSupply()?[['fold:math-help','Math help']]:[]),['fold:storefront','My storefront'],['fold:optional','Optional moves']]
