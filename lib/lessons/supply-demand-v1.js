...
function market(game){return (game.rules||rules).events[game.round-1];}
...
module.exports={id:'supply-demand-v1',label:'Supply & Demand',rules,market,checkPricing,simulateItem,readyError:markup.readyError,calculateOffer:markup.calculateOffer,draftFields:[]};
